...
final class Code2SharedState$_ {
def args = Code2SharedState_sc.args$
def scriptPath = """Code2SharedState.sc"""
/*<script>*/
import fs2.*
...
object Code2SharedState_sc {
  ...
  lazy val script = new Code2SharedState$_
...
export Code2SharedState_sc.script as `Code2SharedState`
